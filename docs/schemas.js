 ...
 *           description: Unique email for the artist
 *         password:
 *           type: string
 *           format: password
 *           description: Password for the artist account
 *         firstName:
 *           type: string
 *           example: "John"
 ...
 *           type: string
 *           example: "artist"
 *           description: Type of the user (e.g., artist)
 *         profilePhoto:
 *           type: string
 *           format: uri
 *           example: "https://example.com/profile.jpg"
 *           description: URL of the artist's profile photo
 *         arts:
 *           type: array
 *           items:
 *             type: string
 *             format: ObjectId
 *           description: Array of ObjectId references to the artist's artworks
 *         soldArts:
 *           type: array
 *           items:
 *             type: string
 *             format: ObjectId
 *           description: Array of ObjectId references to the artist's sold artworks
 *         totalRevenue:
 *           type: number
 *           example: 1500.00
 *           description: Total revenue generated by the artist from sold artworks
 *         address:
 *           type: string
 *           example: "123 Art Street, Art City"
 *           description: Address of the artist
 *         clients:
 *           type: array
 *           items:
 *             type: string
 *             format: ObjectId
 *           description: Array of ObjectId references to the artist's clients
 */
